...
if ! command -v rg >/dev/null 2>&1; then
  alias rg='/Users/srowe/.nvm/versions/node/v24.3.0/lib/node_modules/\@anthropic-ai/claude-code/vendor/ripgrep/x64-darwin/rg'
fi
export PATH=/Users/srowe/.nvm/versions/node/v24.3.0/bin\:/usr/local/bin\:/System/Cryptexes/App/usr/bin\:/usr/bin\:/bin\:/usr/sbin\:/sbin\:/var/run/com.apple.security.cryptexd/codex.system/bootstrap/usr/local/bin\:/var/run/com.apple.security.cryptexd/codex.system/bootstrap/usr/bin\:/var/run/com.apple.security.cryptexd/codex.system/bootstrap/usr/appleinternal/bin\:/usr/local/share/dotnet\:~/.dotnet/tools\:/usr/local/bin\:/Users/srowe/.dotnet/tools
