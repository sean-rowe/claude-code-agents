...
export PATH=~/.local/bin\:/Users/srowe/.nvm/versions/node/v24.5.0/bin\:/usr/local/bin\:/System/Cryptexes/App/usr/bin\:/usr/bin\:/bin\:/usr/sbin\:/sbin\:/var/run/com.apple.security.cryptexd/codex.system/bootstrap/usr/local/bin\:/var/run/com.apple.security.cryptexd/codex.system/bootstrap/usr/bin\:/var/run/com.apple.security.cryptexd/codex.system/bootstrap/usr/appleinternal/bin\:/usr/local/share/dotnet\:~/.dotnet/tools\:/Users/srowe/workspace/jci/node_modules/.bin\:/usr/local/bin\:/Users/srowe/.dotnet/tools
